...
#Test Case 6: Contact Us Form
  Scenario: User should log the contact us form
    ...
    And I enter "Shraddha" name to name field
    And I enter "jasmin11@gmail.com" email to email field
...
#  Test Case 10: Verify Subscription in home page
  Scenario: User should verify the subscription in home page
    ...
    And I enter email address in input "shraddha@gmail.com"
...
#  Test Case 24: Download Invoice after purchase order
  Scenario: User should Download Invoice after purchase order
    ...
    And I send name "Shraddha" and email "shra" to signup
    And I click on button "Signup"
    And I fill all details in signup page "Mrs" "Shraddha@123" "12" "April" "1993" "Shraddha" "Devani" "krishnakunj" "Vastrapur" "India" "Gujarat" "Ahmedabad" "380015" "9926825612"
    ...
    And I enter payment details "Shraddha Devani" "429333311110000" "520" "06" and "2026"
